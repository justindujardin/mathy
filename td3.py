...
```bash
tf_agents/agents/td3/examples/train_eval_rnn_dm \
 --root_dir=$HOME/tmp/td3_rnn/dm/cartpole/ \
 --alsologtostderr
```
"""
...
def train_eval(
    ...
    with tf.compat.v2.summary.record_if(
        ...
        if observations_whitelist is not None:
            ...
            env_wrappers = []
        tf_env = tf_py_environment.TFPyEnvironment(MathEnvironment())
        eval_py_env = tf_py_environment.TFPyEnvironment(MathEnvironment())
