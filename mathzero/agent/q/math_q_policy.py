...
from tf_agents.agents.dqn import dqn_agent, q_network
...
class MathQPolicy(QPolicy):
    """Math environment Q-Policy with masked valid actions"""

    def __init__(
        self, time_step_spec=None, action_spec=None, q_network=None, name=None
    ):
    ...
    def _distribution(self, time_step, policy_state):
        ...
        distribution = MaskedCategorical(
            logits=q_values, mask=tf.ones(q_values.shape), dtype=self._action_dtype
        )
