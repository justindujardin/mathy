...
import numpy
from helper import update_target_graph, process_frame, discount, make_gif
from actor_critic import AC_Network
from vizdoom import ScreenResolution, Button, ScreenFormat, GameVariable, Mode


class Worker:
    def __init__(
        self, game, name, s_size, a_size, trainer, model_path, global_episodes
    ):
