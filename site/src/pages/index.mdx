...
<MathText input="23f + (5f + 5d)" />
<MathTree input="23f + (5f + 5d)" />
<MathText input="(23f + 5f) + 5d" />
<MathTree input="(23f + 5f) + 5d" />
<MathText input="2y^3 + 5f + 3f" />
<MathTree input="2y^3 + 5f + 3f" />
<MathText input="9 * (23f + 5f + 5d)" />
<MathTree input="9 * (23f + 5f + 5d)" />
<MathText input="(23f + 5f + 5d) * 9" />
<MathTree input="(23f + 5f + 5d) * 9" />
