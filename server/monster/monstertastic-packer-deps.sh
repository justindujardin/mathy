...
echo "Downloading and installing Tesla T4 driver..."
gsutil cp gs://shm-builds/nvidia-diag-driver-local-repo-ubuntu1604-396.26_1.0-1_amd64.deb /tmp/
sudo dpkg -i /tmp/nvidia-diag-driver-local-repo-ubuntu1604-396.26_1.0-1_amd64.deb
